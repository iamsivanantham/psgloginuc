...
$ua_info['browser']=strtolower($ua_info['browser']);
if($ua_info['browser'] == "msie" && intval($ua_info['version']) <= 9){
	header("LOCATION: browser.php");
}elseif($ua_info['browser'] == "firefox" && intval($ua_info['version']) <= 16){
	header("LOCATION: browser.php");
}else if(($ua_info['browser'] == "opera" || $ua_info['browser'] == "opera next") && intval($ua_info['version']) <= 12){
	header("LOCATION: browser.php");
}else if($ua_info['browser'] == "safari" && intval($ua_info['version']) <= 5){
	header("LOCATION: browser.php");
}else if($ua_info['browser'] == "chrome" && intval($ua_info['version']) <= 4){
	header("LOCATION: browser.php");
}
